...
export function SocialIcons({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <Link href="https://x.com/HikkiScript" target="_blank" rel="noopener noreferrer">
        <Button 
          variant="outline" 
          size="icon" 
          className="h-12 w-12 border-2 bg-background/50 backdrop-blur hover:bg-accent hover:text-accent-foreground"
      ...
      <Link href="https://youtube.com/@HikkiScript" target="_blank" rel="noopener noreferrer">
        <Button 
          variant="outline" 
          size="icon" 
          className="h-12 w-12 border-2 bg-background/50 backdrop-blur hover:bg-accent hover:text-accent-foreground"
      ...
      <Link href="https://instagram.com/HikkiScript" target="_blank" rel="noopener noreferrer">
        <Button 
          variant="outline" 
          size="icon" 
          className="h-12 w-12 border-2 bg-background/50 backdrop-blur hover:bg-accent hover:text-accent-foreground"
      ...
      <Link href="https://cal.com/HikkiScript" target="_blank" rel="noopener noreferrer">
        <Button 
          variant="outline" 
          size="icon" 
          className="h-12 w-12 border-2 bg-background/50 backdrop-blur hover:bg-accent hover:text-accent-foreground"
      ...
      <Link href="https://hikki.me" target="_blank" rel="noopener noreferrer">
        <Button 
          variant="outline" 
          size="icon" 
          className="h-12 w-12 border-2 bg-background/50 backdrop-blur hover:bg-accent hover:text-accent-foreground"
